...
# # === 1. Încarcă datele din fișierul salvat ===
...
# # === 3. Compilează modelul ===
# model.compile(optimizer="adam", loss="binary_crossentropy", metrics=["accuracy"])

# # === 4. Early stopping ===
# early_stop = EarlyStopping(monitor='val_loss', patience=5, restore_best_weights=True)

# # === 5. Antrenează modelul folosind direct datele ===
# model.fit(
#     X_train, y_train,
...
#     """
#     Creează callbacks pentru training îmbunătățit
#     """
#     timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    
#     callbacks = [
#         # Early stopping îmbunătățit
#         EarlyStopping(
#             monitor='val_accuracy',  # Monitorizează accuracy în loc de loss
#             patience=15,
...
#         rotation_range=3,           # Rotație foarte ușoară
#         width_shift_range=0.08,     # Shift orizontal mic
#         height_shift_range=0.05,    # Shift vertical mic
#         shear_range=0.05,          # Shear foarte ușor
#         zoom_range=0.08,           # Zoom foarte ușor
...
#     """
#     Evaluare detaliată a modelului
#     """
#     print(f"\n{'='*50}")
...
#     # Încearcă să încarce datele din fișierul generat de preprocessing
#     data_files = [
...
#         print("Rulează mai întâi scriptul de preprocessing!")
#         return
...
#     print(f"{'='*60}")
#     print(f"📁 Model salvat: {final_model_name}")
#     print(f"📊 Accuracy finală: {val_results['accuracy']:.4f} ({val_results['accuracy']*100:.2f}%)")
#     print(f"📈 AUC Score: {val_results['auc']:.4f}")
...
#     """
#     Plotează istoricul training-ului
#     """
